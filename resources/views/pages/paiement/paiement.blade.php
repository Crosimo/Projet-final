                                ...
                                <div class="card rounded-0 border-0 card1" id="bill">
                                    ...
                                    <div class="row" style="height: 100%">
                                        <div class="col-lg-7 col-8 mt-4 line pl-4">
                                            <h2 class="bill-head">{{ $pricing->packageTitle }}</h2> <small class="bill-date">{{ $date }}</small>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 red-bg">
                                            ...
                                            <h2 class="bill-head" id="total">{{ $pricing->packagePrice }}</h2> <small class="bill-date" id="total-label">Price includes all taxes</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card rounded-0 border-0 card2" id="paypage">
                                    <div class="form-card">
                                        ...
                                        <div class="radio-group">
                                            <div class='radio' data-value="credit"><img src="{{ asset('img/paiement/logo-visa.png') }}" width="200px" height="60px"></div>
                                            <div class='radio' data-value="paypal"><img src="{{ asset('img/paiement/MasterCard.png') }}" width="200px" height="60px"></div> <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6"> <a class="btn btn-danger" href="/">Make Paiement</a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
